...
const WINESHOP_TOKEN = process.env.SANITY_WINESHOP_TOKEN
const TEST_TOKEN = process.env.SANITY_TEST_TOKEN

if (!WINESHOP_TOKEN || !TEST_TOKEN) {
  console.error('❌ Missing API tokens!')
  console.error('Please set the following environment variables:')
  console.error('  SANITY_WINESHOP_TOKEN - Token for wineshop project (2hqr3d91)')
  console.error('  SANITY_TEST_TOKEN - Token for test project (wp652lez)')
  console.error('')
  ...
  console.error('  SANITY_WINESHOP_TOKEN=your_token SANITY_TEST_TOKEN=your_token node scripts/migrate-with-env-tokens.js')
  process.exit(1)
}
