  ...
  fields: [
   ...
   defineField({
    ...
    defineField({
      ...
      type: 'array',
      of: [{ type: 'string' }],
      description: 'Assign wine to taste collection categories for browse-by-taste feature',
      options: {
        list: [
    ...
    defineField({
      ...
      type: 'string',
      description: 'Custom meta title for SEO (recommended: 50-60 characters). If empty, the product title will be used.',
    ...
    defineField({
      ...
      type: 'text',
      description: 'Custom meta description for SEO (recommended: 150-160 characters). If empty, the product description will be used.',
